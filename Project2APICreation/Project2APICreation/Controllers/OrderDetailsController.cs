...
using Project2APICreation.Models;

namespace Project2APICreation.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class OrderDetailsController : ControllerBase
    {
        private readonly cmpg323SeanContext _context;

        public OrderDetailsController(cmpg323SeanContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetail>> PostOrderDetail(OrderDetail orderDetail)
        {
          if (_context.OrderDetails == null)
          {
              return Problem("Entity set 'cmpg323SeanContext.OrderDetails'  is null.");
          }
